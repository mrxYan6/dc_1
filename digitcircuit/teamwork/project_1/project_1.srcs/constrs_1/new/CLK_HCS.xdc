...
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets MODIFY]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets TYPEe]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets NEXT_CP_ini]
set_property PACKAGE_PIN N17 [get_ports reset]
set_property PACKAGE_PIN P18 [get_ports NEXT_CP_ini]
set_property PACKAGE_PIN P17 [get_ports MODIFY]


set_property IOSTANDARD LVCMOS18 [get_ports TYPEe]
set_property PACKAGE_PIN T14 [get_ports TYPEe]

set_property PACKAGE_PIN V17 [get_ports TMP]
set_property IOSTANDARD LVCMOS18 [get_ports TMP]
